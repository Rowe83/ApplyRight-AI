    ...
    <div className="flex min-h-0 min-w-0 flex-col gap-6">
      ...
      <div className="min-w-0 space-y-2">
        <div className="flex flex-wrap items-center gap-2">
          <FileStack className="h-6 w-6 shrink-0 text-primary drop-shadow-[0_0_10px_rgba(56,189,248,0.4)]" />
        ...
        {filteredTemplates.map((template) => {
          ...
          return (
            <Card
              ...
              role="listitem"
              className={cn(
                "relative flex min-w-0 flex-col overflow-hidden border-primary/20 bg-gradient-to-br from-slate-950/90 via-card/80 to-primary/5",
            ...
            >
              ...
              <CardFooter className="relative z-10 mt-auto flex flex-wrap gap-2 border-t border-border/40 bg-black/10 pt-4">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="min-w-0 flex-1 border-border/80 min-[400px]:flex-none"
                ...
                <Button
                  type="button"
                  size="sm"
                  className="min-w-0 flex-1 bg-primary text-primary-foreground hover:bg-primary/90 min-[400px]:flex-none"
      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        <DialogContent className="max-h-[90vh] max-w-3xl border-primary/20 bg-card/95 p-0 backdrop-blur-md">
          ...
          <ScrollArea className="scrollbar-dark max-h-[55vh] px-6 pb-4">
